...
if (isset($_POST['kirim'])) {
	...
	$queryEmail = mysqli_query($connect, "SELECT * FROM kontak WHERE email='$email'");
	$rowEmail = mysqli_fetch_assoc($queryEmail);

	if ($rowEmail) {
		header("location:index.php?berhasil-kritik");
	} else {
		$insert = mysqli_query($connect, "INSERT INTO kontak (nama, email, subject, message) VALUES ('$nama','$email','$subject','$message')");
		if ($insert) {
			header("location:index.php?berhasil-nich");
		} else {
...
$ubah_resume = mysqli_query($connect, "SELECT * FROM resume");
$r = mysqli_fetch_all($ubah_resume, MYSQLI_ASSOC);

$ubah_about = mysqli_query($connect, "SELECT * FROM pengaturan WHERE id=1 ");
$a = mysqli_fetch_assoc($ubah_about);
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
					...
					<div class="row justify-content-start pb-3">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<ul class="about-info mt-4 px-md-0 px-2">
								<li class="d-flex"><span>Name:</span> <span><?= $a['namaweb'] ?></span></li>
								<li class="d-flex"><span>Address:</span> <span><?= $a['alamat'] ?></span></li>
								<li class="d-flex"><span>Zip code:</span> <span><?= $a['url'] ?></span></li>
								<li class="d-flex"><span>Email:</span> <span><?= $a['email'] ?></span></li>
								<li class="d-flex"><span>Phone: </span> <span><?= $a['telepon'] ?></span></li>
							</ul>
						</div>
					</div>
				...
				?>
					<div class="col-md-6">
						...
						<div class="resume-wrap ftco-animate">
							<span class="date"><?= $resume['tahun_awal'] ?>-<?= $resume['tahun_akhir'] ?></span>
							<h2><?= $resume['skill'] ?></h2>
							<span class="position"><?= $resume['instansi'] ?></span>
							<p class="mt-4"><?= $resume['deskripsi'] ?></p>
						</div>
					<?php
				}
	...
	<section class="ftco-section ftco-project" id="projects-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(assets/fe/images/project-4.jpg);">
						<div class="overlay"></div>
				...
				<div class="col-md-6 order-md-last d-flex">
					<form action="" method="POST" class="bg-light p-4 p-md-5 contact-form">
						<div class="form-group">
							<label for="" class="form-lable m-2">NAME</label>
							<input type="text" class="form-control" name="nama" required placeholder="Your Name">
						</div>
						<div class="form-group">
							<label for="" class="form-lable m-2">EMAIL</label>
							<input type="email" class="form-control" name="email" required placeholder="Your Email">
						</div>
						<div class="form-group">
							<label for="" class="form-lable m-2">SUBJECT</label>
							<input type="text" class="form-control" name="subject" required placeholder="Subject">
						</div>
						<div class="form-group">
							<label for="" class="form-lable m-2">MESSAGE</label>
